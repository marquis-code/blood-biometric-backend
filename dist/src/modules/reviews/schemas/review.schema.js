...
exports.ReviewSchema.index({ doctorId: 1 });
exports.ReviewSchema.index({ patientId: 1 });
exports.ReviewSchema.index({ appointmentId: 1 });
exports.ReviewSchema.index({ rating: 1 });
exports.ReviewSchema.index({ isVisible: 1 });
