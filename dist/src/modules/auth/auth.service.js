...
let AuthService = class AuthService {
    ...
    async register(registerDto) {
        try {
            const user = await this.usersService.create(Object.assign(Object.assign({}, registerDto), { role: registerDto.role || 'patient' }));
            const payload = {
    ...
    async validateGoogleUser(googleUser) {
        ...
        if (!user) {
            ...
            if (user) {
                ...
                user = await this.usersService.create(Object.assign(Object.assign({}, googleUser), { role: 'patient', isVerified: true }));
            }
        }
        const payload = {
            sub: user._id.toString(),
