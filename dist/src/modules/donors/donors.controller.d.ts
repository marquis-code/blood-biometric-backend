...
export declare class DonorsController {
    ...
    findById(id: string): Promise<import("mongoose").Document<unknown, {}, import("./schemas/donor.schema").DonorDocument, {}> & import("./schemas/donor.schema").Donor & import("mongoose").Document<unknown, any, any, Record<string, any>> & Required<{
        _id: unknown;
    }> & {
        __v: number;
    }>;
